...
<h2><spring:message code="reportingcompatibility.ReportObject.title"/></h2>
			...
			<c:if test="${reportObject.reportObjectId == null}" >
				<spring:bind path="reportObject.type">
					<select name="${status.expression}" onChange="document.getElementById('reportObjectForm').submit();">
						<option value=""><spring:message code="reportingcompatibility.ReportObject.type.chooseone"/></option>
			...
			<td valign="top" colspan="5">
				<c:if test="${reportObject.reportObjectId == null}" >
					<spring:bind path="reportObject.subType">
						<select name="${status.expression}" onChange="document.getElementById('reportObjectForm').submit();">
							<option value=""><spring:message code="reportingcompatibility.ReportObject.subtype.chooseone"/></option>
...
<br />
<input type="submit" name="submitted" value="<spring:message code="reportingcompatibility.ReportObject.save"/>">
</c:if>
</form>
