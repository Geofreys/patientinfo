...
<h2><spring:message code="reportingcompatibility.RowPerObsDataExport.manage.title"/></h2>	

<spring:message code="reportingcompatibility.RowPerObsDataExport.help" /><br/><br/>

<a href="rowPerObsDataExport.form"><spring:message code="reportingcompatibility.RowPerObsDataExport.add"/></a> <br />

<br />

<b class="boxHeader"><spring:message code="reportingcompatibility.RowPerObsDataExport.list.title"/></b>
