...
<h2><spring:message code="reportingcompatibility.PatientSearch.manage.title" /></h2>
...
<input type="submit"
	value='<spring:message code="reportingcompatibility.PatientSearch.delete"/>' name="action"
