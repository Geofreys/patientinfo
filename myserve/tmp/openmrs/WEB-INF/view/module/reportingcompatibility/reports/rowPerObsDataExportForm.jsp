...
<div id="xmlData">
	...
	<div class="tabBar">
		<a id="defineCohortTab" class="tab" href="#selectCohort" onclick="return selectTab(this)"><spring:message code="reportingcompatibility.DataExport.defineCohort"/></a>
		<a id="defineColumnsTab" class="tab" href="#selectColumns" onclick="return selectTab(this)"><spring:message code="reportingcompatibility.DataExport.defineColumns"/></a>
	</div>
	...
	<div id="defineCohort" class="box">
		<table>
			<tr>
				<th colspan="2"><spring:message code="reportingcompatibility.DataExport.cohortMatch"/></th>
			</tr>
			<tr>
				<td><spring:message code="reportingcompatibility.CohortBuilder.savedSearches"/></td>
				<td>
			...
			<tr>
				<td><spring:message code="reportingcompatibility.CohortDefinition.title"/></td>
				<td>
			...
			<tr>
				<th colspan="2"><spring:message code="reportingcompatibility.DataExport.encounterMatch"/></th>
			</tr>
			<!--
			<tr>
				<td><spring:message code="reportingcompatibility.DataExport.startDate"/></td>
				<td><input type="text" name="startDate" onClick="showCalendar(this)" /></td>
			</tr>
			<tr>
				<td><spring:message code="reportingcompatibility.DataExport.endDate"/></td>
				<td><input type="text" name="endDate" onClick="showCalendar(this)" /></td>
			</tr>
			-->
			<tr>
				<td><spring:message code="reportingcompatibility.DataExport.location"/></td>
				<td>
					<spring:bind path="dataExport.location">
						<select name="location">
							<option value=""><spring:message code="reportingcompatibility.DataExport.allLocations"/></option>
			...
			<tr>
				<th colspan="2"><spring:message code="reportingcompatibility.DataExport.patientMatch"/></th>
			</tr>
			<tr>
				<td colspan="2">
					...
					<input type="button" onClick="return addNew(this, 'newPatient');" class="addNew" id="newPatientButton" value='<spring:message code="reportingcompatibility.DataExport.addPatient" />' />
					<br/>
				</td>
			</tr>
		</table>
	...
	<div id="defineColumns" class="box">
		<div id="newColumn" class="dataexportcolumn" style="display: none">
			<div class="tabBar">
				...
				<a id="calcTab" class="tab" href="#selectCalcTab" onclick="selectTab(this)"><spring:message code="reportingcompatibility.DataExport.calculatedTab"/></a>
				<a id="cohortTab" class="tab" href="#selectCohortTab" onclick="selectTab(this)"><spring:message code="reportingcompatibility.DataExport.cohortTab"/></a>
				&nbsp; 
			...
			<div id="concept" class="box">
				<spring:message code="reportingcompatibility.RowPerObsDataExport.onlyOneConcept" /><br/>
...
<c:if test="${dataExport.reportObjectId != null}">
	<br />
	<input type="checkbox" id="saveAsNew" name="saveAsNew" value="1" /><label for="saveAsNew"><spring:message code="reportingcompatibility.DataExport.saveAs"/></label>
</c:if>
<br />
<input type="submit" name="action" value='<spring:message code="reportingcompatibility.DataExport.save"/>'>
<!-- <input type="submit" name="action" value='<spring:message code="reportingcompatibility.DataExport.saveGenerate"/>' onclick="redirectPage('dataExport.list')"> -->
</form>
